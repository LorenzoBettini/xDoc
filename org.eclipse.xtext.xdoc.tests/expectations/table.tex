...
stringstyle=\color{strcolor}, columns=[r]fullflexible, escapechar={ﬂ}, frame=single, %framexleftmargin=-5pt, framexrightmargin=-5pt, 
...
\noindent\begin{tabular}{|p{0.5\XdocTEffectiveWidth}|p{0.5\XdocTEffectiveWidth}|}
foo
